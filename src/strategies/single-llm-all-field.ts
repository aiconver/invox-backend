...
function buildPrompt({
  ...
  const header = de
    ? [
      ...
      "Auch wenn der aktuelle Wert vom Benutzer stammt: Wenn das NEUE Transkript eine eindeutige Korrektur enthält, AKTUALISIEREN.",
    ...
    : [
      ...
      "Even if the current value is user-provided: if the NEW transcript clearly corrects it, UPDATE it.",
